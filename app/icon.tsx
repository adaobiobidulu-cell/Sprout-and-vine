    ...
    (
      ...
      >
        ...
        >
          ...
          <path d="M 22 14 C 32 8 46 12 50 24 C 54 36 46 46 34 46 C 22 46 14 38 16 28 C 18 20 26 16 34 18 C 42 20 46 30 42 38" stroke="#F7F2E8" strokeWidth="2.8" strokeLinecap="round" fill="none" />
          <path d="M 18 32 C 14 42 12 58 18 66 C 24 74 38 76 48 70 C 56 65 56 55 50 52 C 44 49 34 52 30 56" stroke="#F7F2E8" strokeWidth="2.8" strokeLinecap="round" fill="none" />
