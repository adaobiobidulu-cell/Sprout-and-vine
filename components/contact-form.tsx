...
const copy = {
  en: {
    ...
    sending: 'Sending...',
    submit: 'Book my demo',
    errorMsg: 'Something went wrong sending your message. Please email us directly at hello@sproutandvinecare.ca.',
  ...
  fr: {
    ...
    errorMsg: 'Un problème est survenu. Envoyez-nous un courriel à hello@sproutandvinecare.ca.',
